        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-amber-100 mb-8">
              Our Family Valley View package includes exclusive experiences
              designed to bring your family closer to nature and each other.
            </p>
            <Button
              as={Link}
              to="/experiences"
              ...
              <div className="mt-6 bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-100 dark:border-gray-700">
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="text-sm text-gray-600 dark:text-gray-400">
                    {FamilyValleyView.rating} from 127 family reviews
                  </span>
                </div>
                <Button
                  variant="outline"
