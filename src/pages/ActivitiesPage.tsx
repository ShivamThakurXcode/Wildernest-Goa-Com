  ...
  return (
    <>
      ...
      <Section className="bg-amber-50 dark:bg-gray-800">
        <div className="max-w-4xl mx-auto text-center mb-16">
          <h2 className="text-3xl font-bold mb-6">Guest Adventures</h2>
          <p className="text-lg text-gray-600 dark:text-gray-400">
            Hear from travelers who've experienced our activities
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            {
              quote:
                "The jungle survival camp exceeded all expectations! Three days of pure adventure that changed how I see nature.",
              author: "Rahul K.",
              activity: "Jungle Survival Camp",
              rating: 5,
              avatar: "https://randomuser.me/api/portraits/men/32.jpg",
            },
            {
              quote:
                "Our family still talks about the beach olympics. The kids made friends and we all laughed more than we had in years!",
              author: "Priya M.",
              activity: "Family Beach Olympics",
              rating: 5,
              avatar: "https://randomuser.me/api/portraits/women/44.jpg",
            },
            {
              quote:
                "Kayaking through the mangroves at sunset was magical. Our guide knew all the hidden spots for wildlife viewing.",
              author: "Arjun & Neha",
              activity: "Mangrove Kayaking",
              rating: 4,
      ...
      {/* CTA Section */}
      <Section>
        <div className="bg-gradient-to-r from-amber-600 to-amber-500 rounded-3xl p-8 md:p-12 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">
            Ready for Adventure?
          </h2>
          <p className="text-xl text-amber-100 mb-8 max-w-2xl mx-auto">
            Book your activities now or speak with our experience concierge to
